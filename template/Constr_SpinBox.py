...
class Ui_DialogConstr(object):
    def setupUi(self, DialogConstr):
        ...
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.inputHs)
        ...
        self.formLayout_4.setWidget(
            1, QFormLayout.FieldRole, self.comboBoxFibra)
        ...
        self.formLayout_4.setWidget(
            4, QFormLayout.LabelRole, self.iccPicoKALabel)
        ...
        self.input_Folga.setMinimum(0.950000000000000)
        self.input_Folga.setMaximum(1.050000000000000)
        ...
        sizePolicy.setHeightForWidth(
            self.comboBox_metodo_temp.sizePolicy().hasHeightForWidth())
        self.comboBox_metodo_temp.setSizePolicy(sizePolicy)
        self.comboBox_metodo_temp.setBaseSize(QSize(19, 0))

        self.formLayout_4.setWidget(
            7, QFormLayout.FieldRole, self.comboBox_metodo_temp)
        ...
        self.formLayout_4.setWidget(
            9, QFormLayout.LabelRole, self.label_Hot_Spot)
        ...
        self.formLayout_4.setWidget(
            10, QFormLayout.FieldRole, self.inputPerdas)
        ...
        self.formLayout_2.setWidget(
            0, QFormLayout.LabelRole, self.temperaturaAmbienteCLabel)
        ...
        self.formLayout_2.setWidget(
            1, QFormLayout.LabelRole, self.temperaturaDeReferNciaCLabel)
        ...
        self.formLayout_2.setWidget(
            2, QFormLayout.LabelRole, self.indutNciaNominalMHLabel)
        ...
        self.formLayout_2.setWidget(
            3, QFormLayout.LabelRole, self.indutNciaAlvoMHLabel)
        ...
        self.formLayout_2.setWidget(
            5, QFormLayout.LabelRole, self.correnteTotalALabel)
        ...
        self.formLayout_2.setWidget(
            6, QFormLayout.FieldRole, self.inputNBI_Esp)
        ...
        self.formLayout_2.setWidget(
            8, QFormLayout.FieldRole, self.inputNBI_Cam)
        ...
        self.formLayout_2.setWidget(
            9, QFormLayout.FieldRole, self.inputNBI_Cil)
        ...
        self.formLayout_3.setWidget(
            1, QFormLayout.FieldRole, self.inputCompress)
        ...
        self.formLayout_3.setWidget(
            8, QFormLayout.FieldRole, self.doubleSpinBox)
        ...
        self.formLayout_3.setWidget(
            9, QFormLayout.FieldRole, self.doubleSpinBox_3)

        self.comboBoxNormaIcc = QComboBox(self.frame)
        self.comboBoxNormaIcc.setObjectName(u"comboBoxNormaIcc")
        self.comboBoxNormaIcc.setEnabled(False)
        self.comboBoxNormaIcc.setEditable(False)

        self.formLayout_3.setWidget(
            2, QFormLayout.LabelRole, self.comboBoxNormaIcc)

        self.comboBox_TempIcc = QComboBox(self.frame)
        self.comboBox_TempIcc.setObjectName(u"comboBox_TempIcc")
        self.comboBox_TempIcc.setEnabled(False)

        self.formLayout_3.setWidget(
            2, QFormLayout.FieldRole, self.comboBox_TempIcc)

        self.comboBox_IccMax = QComboBox(self.frame)
        self.comboBox_IccMax.setObjectName(u"comboBox_IccMax")
        self.comboBox_IccMax.setEnabled(False)

        self.formLayout_3.setWidget(
            3, QFormLayout.FieldRole, self.comboBox_IccMax)
        ...
        QWidget.setTabOrder(self.comboBox_metodo_temp, self.comboBoxNormaIcc)
        QWidget.setTabOrder(self.comboBoxNormaIcc, self.checkBoxAutoTurn)
        ...
        QWidget.setTabOrder(self.comboBox_IccMax, self.btn_calc)
        QWidget.setTabOrder(self.btn_calc, self.bt_inicial)
    ...
    def retranslateUi(self, DialogConstr):
        ...
        self.label_4.setText(QCoreApplication.translate(
            "DialogConstr", u"Classe de temperatura(\u00b0C)", None))
        ...
        self.inputAnelInf.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"50.0", None))
        self.inputAnelInf.setProperty("inputMask", "")
        self.inputAnelInf.setProperty("placeholderText", QCoreApplication.translate(
        ...
        self.inputAnelSup.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"50.0", None))
        self.nBIKVLabel.setText(QCoreApplication.translate(
            "DialogConstr", u"Di\u00e2metro interno (mm)", None))
        self.inputDi.setProperty("text", QCoreApplication.translate(
            "DialogConstr", u"1000.0", None))
        ...
        self.inputLargEsp.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"19.05", None))
        ...
        self.label_17.setText(QCoreApplication.translate(
            "DialogConstr", u"Altura do reator (mm)", None))
        self.label_6.setText(QCoreApplication.translate(
            "DialogConstr", u"Espessura das fibra(mm)", None))
        self.duraOSLabel.setText(QCoreApplication.translate(
            "DialogConstr", u"# Fios Axiais", None))
        self.inputAxial.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"1", None))
        self.iccPicoKALabel.setText(QCoreApplication.translate(
            "DialogConstr", u"# Fios Radiais", None))
        self.inputRadial.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"4", None))
        self.label_5.setText(QCoreApplication.translate(
            "DialogConstr", u"AWG do primeiro cilindro", None))
        self.label_8.setText(QCoreApplication.translate(
            "DialogConstr", u"Fator de folga", None))
        self.input_Folga.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"1.000", None))
        self.label_9.setText(QCoreApplication.translate(
            "DialogConstr", u"M\u00e9todo de c\u00e1lculo da temperatura", None))
        self.comboBox_metodo_temp.setItemText(
            0, QCoreApplication.translate("DialogConstr", u"Heat constant", None))
        self.comboBox_metodo_temp.setItemText(
            1, QCoreApplication.translate("DialogConstr", u"Dubell", None))

        self.label_Tmed.setText(QCoreApplication.translate(
            "DialogConstr", u"Tmed (\u00b0C)", None))
        self.InputTmed.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"0.0", None))
        self.label_Hot_Spot.setText(QCoreApplication.translate(
            "DialogConstr", u"Hot Spot (\u00b0C)", None))
        self.inputHotSpot.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"0.0", None))
        self.correnteNominalALabel.setText(QCoreApplication.translate(
            "DialogConstr", u"Perdas DC (kW) @ 75 \u00b0C", None))
        self.label_20.setText(QCoreApplication.translate(
            "DialogConstr", u"Dist\u00e2ncia entre cruzetas (mm)", None))
        self.temperaturaAmbienteCLabel.setText(QCoreApplication.translate(
            "DialogConstr", u"Se\u00e7\u00e3o condutora mm\u00b2", None))
        self.inputSecao.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"0.0", None))
        self.temperaturaDeReferNciaCLabel.setText(QCoreApplication.translate(
            "DialogConstr", u"Densidade de corrente em DC (A/mm\u00b2)", None))
        self.inputJdc.setProperty(
            "text", QCoreApplication.translate("DialogConstr", u"0.000", None))
        ...
        self.label_10.setText(QCoreApplication.translate(
            "DialogConstr", u"NBI/Esp (kV/esp) < 10 kV/esp", None))
        self.label_11.setText(QCoreApplication.translate(
            "DialogConstr", u"NBI/He (kV/mm) < 0.5 kV/mm", None))
        self.label_12.setText(QCoreApplication.translate(
            "DialogConstr", u"NBI Cam (kV/mm) < 10 kV/mm", None))
        self.label.setText(QCoreApplication.translate(
            "DialogConstr", u"NBI Cil (kV/mm) < 50 kV/mm", None))
        self.label_7.setText(QCoreApplication.translate(
            "DialogConstr", u"Perdas AC (kW) @ 75 \u00b0C", None))
        self.label_18.setText(QCoreApplication.translate(
            "DialogConstr", u"Hoop (Mpa) < 350 Mpa", None))
        self.label_19.setText(QCoreApplication.translate(
            "DialogConstr", u"Comp (Mpa) < 135 Mpa", None))
        self.label_2.setText(QCoreApplication.translate(
            "DialogConstr", u"Cs (pF)", None))
        self.label_13.setText(QCoreApplication.translate(
            "DialogConstr", u"Cp (pF)", None))
        self.Cg9pF.setText(QCoreApplication.translate(
            "DialogConstr", u"Cg (pF)", None))
        self.label_14.setText(QCoreApplication.translate(
            "DialogConstr", u"C\u221e (pF)", None))
        self.label_15.setText(QCoreApplication.translate(
            "DialogConstr", u"CeffG (pF)", None))
        self.label_16.setText(QCoreApplication.translate(
            "DialogConstr", u"Ceff_Ug (pF)", None))
        self.checkBoxAutoTurn.setText(QCoreApplication.translate(
            "DialogConstr", u"Auto Espira", None))
        self.checkBoxHe.setText(QCoreApplication.translate(
            "DialogConstr", u"Auto Altura", None))
        ...
        self.btnFreeCad.setText(QCoreApplication.translate(
            "DialogConstr", u"FreeCad", None))
