...
class Ui_DialogConstr(object):
    def setupUi(self, DialogConstr):
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.condutorComboBox)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.comboBoxClasse)

        self.frequNciaHzLabel = QLabel(self.frame)
        self.frequNciaHzLabel.setObjectName(u"frequNciaHzLabel")

        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.frequNciaHzLabel)
        ...
        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.tensONominalVLabel)
        ...
        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.altitudeMLabel)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.comboBoxCruzInf)
        ...
        self.formLayout.setWidget(8, QFormLayout.FieldRole, self.comboBoxCruzSup)
        ...
        self.formLayout_4.setWidget(1, QFormLayout.LabelRole, self.iccPicoKALabel)
        ...
        self.formLayout_4.setWidget(2, QFormLayout.LabelRole, self.temperaturaAmbienteCLabel)
        ...
        self.formLayout_4.setWidget(3, QFormLayout.LabelRole, self.temperaturaDeReferNciaCLabel)
        ...
        self.formLayout_4.setWidget(4, QFormLayout.LabelRole, self.indutNciaNominalMHLabel)
        ...
        self.formLayout_4.setWidget(5, QFormLayout.LabelRole, self.indutNciaAlvoMHLabel)
        ...
        self.formLayout_4.setWidget(6, QFormLayout.LabelRole, self.correnteNominalALabel)
        ...
        self.formLayout_4.setWidget(8, QFormLayout.LabelRole, self.correnteTotalALabel)
        ...
        self.formLayout_4.setWidget(9, QFormLayout.LabelRole, self.label)

        self.InputTmed = QLineEdit(self.frame)
        self.InputTmed.setObjectName(u"InputTmed")
        self.InputTmed.setReadOnly(True)

        self.formLayout_4.setWidget(9, QFormLayout.FieldRole, self.InputTmed)

        self.label_2 = QLabel(self.frame)
        self.label_2.setObjectName(u"label_2")

        self.formLayout_4.setWidget(10, QFormLayout.LabelRole, self.label_2)

        self.inputHotSpot = QLineEdit(self.frame)
        self.inputHotSpot.setObjectName(u"inputHotSpot")
        self.inputHotSpot.setReadOnly(True)

        self.formLayout_4.setWidget(10, QFormLayout.FieldRole, self.inputHotSpot)
        ...
        self.pushButton_2 = QPushButton(DialogConstr)
        ...
        self.btn_cancel = QPushButton(DialogConstr)
        ...
        QWidget.setTabOrder(self.btn_calc, self.btn_Ok)
    ...
    def retranslateUi(self, DialogConstr):
        ...
        self.condutorComboBox.setItemText(4, QCoreApplication.translate("DialogConstr", u"ANSI C57.21 - Reator Shunt", None))
        self.condutorComboBox.setItemText(5, QCoreApplication.translate("DialogConstr", u"Liga de Al", None))

        self.label_4.setText(QCoreApplication.translate("DialogConstr", u"Classe de temperatura do isolamento (\u00b0C)", None))
        ...
        self.inputAnelInf.setText(QCoreApplication.translate("DialogConstr", u"50", None))
        self.inputAnelInf.setPlaceholderText(QCoreApplication.translate("DialogConstr", u"Entre com a frequ\u00eancia industrial", None))
        self.tensONominalVLabel.setText(QCoreApplication.translate("DialogConstr", u"Anel de firbra superior (mm) ", None))
        self.inputAnelSup.setText(QCoreApplication.translate("DialogConstr", u"50", None))
        self.nBIKVLabel.setText(QCoreApplication.translate("DialogConstr", u"Di\u00e2metro interno (mm)", None))
        self.inputDi.setText(QCoreApplication.translate("DialogConstr", u"1000", None))
        ...
        self.inputLargEsp.setText(QCoreApplication.translate("DialogConstr", u"19.05", None))
        ...
        self.label_6.setText(QCoreApplication.translate("DialogConstr", u"Espessura das fibras de vidro (mm)", None))
        ...
        self.input_Folga.setText(QCoreApplication.translate("DialogConstr", u"1.0", None))
        self.duraOSLabel.setText(QCoreApplication.translate("DialogConstr", u"# Fios Axiais", None))
        self.inputAxial.setText(QCoreApplication.translate("DialogConstr", u"1", None))
        self.iccPicoKALabel.setText(QCoreApplication.translate("DialogConstr", u"# Fios Radiais", None))
        self.inputRadial.setText(QCoreApplication.translate("DialogConstr", u"4", None))
        ...
        self.correnteNominalALabel.setText(QCoreApplication.translate("DialogConstr", u"Perdas DC (kW)", None))
        self.correnteTotalALabel.setText(QCoreApplication.translate("DialogConstr", u"Fator Q", None))
        self.label.setText(QCoreApplication.translate("DialogConstr", u"Tmed (\u00b0C)", None))
        self.InputTmed.setText("")
        self.label_2.setText(QCoreApplication.translate("DialogConstr", u"Hot Spot (\u00b0C)", None))
        self.inputHotSpot.setText("")
        self.label_7.setText(QCoreApplication.translate("DialogConstr", u"Perdas AC (kW)", None))
        self.pushButton_2.setText(QCoreApplication.translate("DialogConstr", u"PushButton", None))
        self.checkBoxAuto.setText(QCoreApplication.translate("DialogConstr", u"Auto", None))
        ...
        self.btn_cancel.setText(QCoreApplication.translate("DialogConstr", u"Cancelar", None))
    # retranslateUi
